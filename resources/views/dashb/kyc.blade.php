        ...
        <!-- end of wrapper-side -->
          <div class="grid-content dash-content">
            <div class="grid-items">
              <figure class="kyc-info">
                <p>
                  please submit a clear copy of your identity document for approval
                </p>
                <p>
                  only the following documents will be accepted as proof of
                  identification
                </p>
                <li>
                  international passport (upload 1st and 2nd page of passport using
                  both upload fields
                </li>
                <li>drivers licence (front and back)</li>
                <li>voter's card (front and back)</li>
                <li>national id card (front and back)</li>
              </figure>
              <figure class="kyc-info2">
                <p>proof of identity guidance</p>
                <li>
                  please upload a copy of your valid identification in png , jpeg or
                  pdf format , no larger than 4mb in size
                </li>
                <li>the image must be high quality, unobstructed and uncropped</li>
                <li>
                  the image must show a full document page or in case of national id
                  photocards , both sides of the card
                </li>
                <li>
                  document must be valid and display a clear facial picture of the
                  applicant
                </li>
                <li>first , second and last name of applicant</li>
                <li>date of birth</li>
                <li>document date of issue and expiry</li>
